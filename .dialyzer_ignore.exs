[
  ...
  {"lib/cms/api.ex", :call_with_opaque},
  ...
  {"lib/dotcom/system_status/subway.ex", :call_without_opaque},
  ...
  {"lib/dotcom_web/controllers/mbta_go_feedback_controller.ex", :call_without_opaque},
  ...
  {"lib/dotcom_web/views/fare_view.ex", :call_without_opaque},
  ...
  {"lib/stops/api.ex", :call_without_opaque},
