...
function printQuoted(_this__u8e3s4, value) {
  _init_properties_StringOps_kt__fcy1db();
  _this__u8e3s4.ic(_Char___init__impl__6a9atx(34));
  var lastPos = 0;
  ...
  if (inductionVariable <= last)
    do {
      ...
      if (c < get_ESCAPE_STRINGS().length && !(get_ESCAPE_STRINGS()[c] == null)) {
        _this__u8e3s4.bj(value, lastPos, i);
        _this__u8e3s4.hc(get_ESCAPE_STRINGS()[c]);
        lastPos = i + 1 | 0;
      }
    }
     while (inductionVariable <= last);
  if (!(lastPos === 0))
    _this__u8e3s4.bj(value, lastPos, value.length);
  else
    _this__u8e3s4.hc(value);
  _this__u8e3s4.ic(_Char___init__impl__6a9atx(34));
}
...
export {
  printQuoted as printQuotedmgc3s3pgfors,
  toBooleanStrictOrNull as toBooleanStrictOrNull2hf9surgqf5vr,
};
//endregion

//# sourceMappingURL=StringOps.mjs.map
