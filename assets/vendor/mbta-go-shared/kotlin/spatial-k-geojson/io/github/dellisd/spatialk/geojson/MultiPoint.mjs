  ...
  if (CompanionClass === VOID) {
    class $ {
      y1x(json) {
        ...
        if (!(get_jsonPrimitive(getValue(json, 'type')).n1n() === 'MultiPoint')) {
          var message = 'Object "type" is not "MultiPoint".';
        ...
        return MultiPoint().p1y(coords, bbox);
      }
    }
...
var MultiPointClass;
function MultiPoint() {
  if (MultiPointClass === VOID) {
    class $ extends Geometry() {
      static p1y(coordinates, bbox) {
        bbox = bbox === VOID ? null : bbox;
        var $this = this.z1x();
        $this.n1y_1 = coordinates;
        $this.o1y_1 = bbox;
        return $this;
      }
      a1y() {
      ...
      equals(other) {
        ...
        if (!equals(this.n1y_1, other.n1y_1))
          return false;
        if (!equals(this.o1y_1, other.o1y_1))
          return false;
        return true;
      }
      hashCode() {
      ...
      x1x() {
        var tmp = jsonProp(this.o1y_1);
        return '{"type":"MultiPoint",' + tmp + '"coordinates":' + jsonJoin(this.n1y_1, Position$json$ref()) + '}';
      }
    }
    initMetadataForClass($, 'MultiPoint', VOID, VOID, VOID, VOID, VOID, {0: GeometrySerializer_getInstance});
    MultiPointClass = $;
  }
...
export {
  Companion_instance as Companion_instance3665m1nia2bt9,
  MultiPoint as MultiPoint2ax03dtqdaccf,
};
//endregion
