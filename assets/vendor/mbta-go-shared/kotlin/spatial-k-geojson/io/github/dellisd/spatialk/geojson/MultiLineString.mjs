  ...
  if (CompanionClass === VOID) {
    class $ {
      y1x(json) {
        ...
        if (!(get_jsonPrimitive(getValue(json, 'type')).n1n() === 'MultiLineString')) {
          var message = 'Object "type" is not "MultiLineString".';
        ...
        return MultiLineString().m1y(coords, bbox);
      }
    }
...
function MultiLineString$json$lambda(it) {
...
var MultiLineStringClass;
function MultiLineString() {
  if (MultiLineStringClass === VOID) {
    class $ extends Geometry() {
      static m1y(coordinates, bbox) {
        bbox = bbox === VOID ? null : bbox;
        var $this = this.z1x();
        $this.k1y_1 = coordinates;
        $this.l1y_1 = bbox;
        // Inline function 'kotlin.collections.forEach' call
        var _iterator__ex2g4s = $this.k1y_1.x();
        while (_iterator__ex2g4s.y()) {
      ...
      equals(other) {
        ...
        if (!(other instanceof MultiLineString()))
          THROW_CCE();
        if (!equals(this.k1y_1, other.k1y_1))
          return false;
        if (!equals(this.l1y_1, other.l1y_1))
          return false;
        return true;
      }
      hashCode() {
        var result = hashCode(this.k1y_1);
      ...
      x1x() {
        var tmp = jsonProp(this.l1y_1);
        return '{"type":"MultiLineString",' + tmp + '"coordinates":' + jsonJoin(this.k1y_1, MultiLineString$json$lambda) + '}';
      }
    }
    initMetadataForClass($, 'MultiLineString', VOID, VOID, VOID, VOID, VOID, {0: GeometrySerializer_getInstance});
...
export {
  Companion_instance as Companion_instance343bkjmmoqkl,
  MultiLineString as MultiLineString3nml0jg8am8is,
};
//endregion
