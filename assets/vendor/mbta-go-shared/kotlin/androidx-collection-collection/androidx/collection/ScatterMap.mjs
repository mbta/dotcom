...
function initializeMetadata($this, capacity) {
  ...
  if (capacity === 0) {
    ...
    var i = capacity >> 3;
    var b = (capacity & 7) << 3;
    this_0[i] = this_0[i].s4((new (Long())(255, 0)).p4(b).n4()).t4(value.p4(b));
    tmp_0 = this_0;
  }
  tmp.v6e_1 = tmp_0;
...
function initializeGrowth($this) {
  $this.f6f_1 = loadedCapacity($this.p6b()) - $this.z6e_1 | 0;
}
function findFirstAvailableSlot($this, hash1) {
  var probeMask = $this.y6e_1;
...
var MutableScatterMapClass;
function MutableScatterMap() {
  if (MutableScatterMapClass === VOID) {
    class $ extends ScatterMap() {
      ...
      g6f(key, value) {
        ...
        var index = this.h6f(key);
        var index_0 = index < 0 ? ~index : index;
        this.w6e_1[index_0] = key;
        this.x6e_1[index_0] = value;
      }
      u3(key) {
        var tmp$ret$10;
        $l$block: {
          ...
          $l$loop_0: while (true) {
            ...
            $l$loop: while (true) {
              ...
              if (equals(this.w6e_1[index], key)) {
                tmp$ret$10 = index;
                break $l$block;
              }
        ...
        if (index_0 >= 0) {
          return this.r6c(index_0);
        }
        return null;
      }
      r6c(index) {
        this.z6e_1 = this.z6e_1 - 1 | 0;
        var tmp0 = this.v6e_1;
        var tmp2 = this.y6e_1;
        ...
        this.w6e_1[index] = null;
        var oldValue = this.x6e_1[index];
        this.x6e_1[index] = null;
        return (oldValue == null ? true : !(oldValue == null)) ? oldValue : THROW_CCE();
      }
      p3() {
        this.z6e_1 = 0;
        if (!(this.v6e_1 === get_EmptyGroup())) {
          fill(this.v6e_1, new (Long())(-2139062144, -2139062144));
          var tmp0 = this.v6e_1;
          var tmp2 = this.y6e_1;
          // Inline function 'androidx.collection.writeRawMetadata' call
          var value = new (Long())(255, 0);
        ...
        fill_0(this.x6e_1, null, 0, this.y6e_1);
        fill_0(this.w6e_1, null, 0, this.y6e_1);
        initializeGrowth(this);
      }
      h6f(key) {
        // Inline function 'androidx.collection.hash' call
        ...
        if (this.f6f_1 === 0) {
          ...
          tmp_0 = !this.v6e_1[offset_0 >> 3].q4((offset_0 & 7) << 3).s4(new (Long())(255, 0)).equals(new (Long())(254, 0));
        } else {
          tmp_0 = false;
        }
        if (tmp_0) {
        ...
        this.z6e_1 = this.z6e_1 + 1 | 0;
        var tmp_1 = this;
        var tmp_2 = this.f6f_1;
        var tmp_3;
        // Inline function 'androidx.collection.isEmpty' call
        // Inline function 'androidx.collection.readRawMetadata' call
        var offset_1 = index_0;
        if (this.v6e_1[offset_1 >> 3].q4((offset_1 & 7) << 3).s4(new (Long())(255, 0)).equals(new (Long())(128, 0))) {
          tmp_3 = 1;
        } else {
          tmp_3 = 0;
        }
        tmp_1.f6f_1 = tmp_2 - tmp_3 | 0;
        var tmp0_0 = this.v6e_1;
        var tmp2 = this.y6e_1;
        var tmp4 = index_0;
        // Inline function 'androidx.collection.writeMetadata' call
        // Inline function 'androidx.collection.writeRawMetadata' call
      ...
      q6b() {
        ...
        if (tmp) {
          ...
          this.r6b(nextCapacity(this.y6e_1));
        }
      }
      s6b() {
        var metadata = this.v6e_1;
        var capacity = this.y6e_1;
        var keys = this.w6e_1;
        var values = this.x6e_1;
      ...
      r6b(newCapacity) {
        var previousMetadata = this.v6e_1;
        var previousKeys = this.w6e_1;
        var previousValues = this.x6e_1;
        var previousCapacity = this.y6e_1;
        initializeStorage(this, newCapacity);
        var newMetadata = this.v6e_1;
        var newKeys = this.w6e_1;
        var newValues = this.x6e_1;
        var capacity = this.y6e_1;
        var inductionVariable = 0;
    ...
    initMetadataForClass($, 'MutableScatterMap', MutableScatterMap);
    MutableScatterMapClass = $;
  }
  return MutableScatterMapClass;
}
var ScatterMapClass;
function ScatterMap() {
  if (ScatterMapClass === VOID) {
    class $ {
      constructor() {
        this.v6e_1 = get_EmptyGroup();
        this.w6e_1 = get_EMPTY_OBJECTS();
        this.x6e_1 = get_EMPTY_OBJECTS();
        this.y6e_1 = 0;
        this.z6e_1 = 0;
      }
      p6b() {
                ...
                if (inductionVariable_0 < bitCount)
                  do {
                    ...
                    if (slot.s4(new (Long())(255, 0)).d2(new (Long())(128, 0)) < 0) {
                      ...
                      var value = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
                      if (value == null) {
                        if (!(o.j3(tmp0) == null) || !o.h3(tmp0)) {
                          return false;
                        }
                      } else if (!equals(value, o.j3(tmp0))) {
                        return false;
                      }
                    }
                    slot = slot.q4(8);
                ...
                if (inductionVariable_0 < bitCount)
                  do {
                    ...
                    if (slot.s4(new (Long())(255, 0)).d2(new (Long())(128, 0)) < 0) {
                      ...
                      var tmp_0 = v[index];
                      var value = (tmp_0 == null ? true : !(tmp_0 == null)) ? tmp_0 : THROW_CCE();
                      s.gc(tmp0 === this ? '(this)' : tmp0);
                      s.hc('=');
                      s.gc(value === this ? '(this)' : value);
                      i = i + 1 | 0;
                      if (i < this.z6e_1) {
    ...
    initMetadataForClass($, 'ScatterMap');
    ScatterMapClass = $;
  }
  return ScatterMapClass;
}
...
export {
  get_EmptyGroup as get_EmptyGroup3quv3ubythwh0,
  MutableScatterMap as MutableScatterMap1d9bz6zagr1rv,
  emptyScatterMap as emptyScatterMap2oiup8h20o52n,
  loadedCapacity as loadedCapacity2ixp8rhrflbpr,
  mutableScatterMapOf as mutableScatterMapOf3abcfp1zp1j0e,
  nextCapacity as nextCapacity2etcq869vd6gg,
  normalizeCapacity as normalizeCapacity3ebzihg7o4adm,
  unloadedCapacity as unloadedCapacity3djxu9qdm2sj6,
};
//endregion

//# sourceMappingURL=ScatterMap.mjs.map
