...
function initializeStorage($this, initialCapacity) {
  ...
  var newCapacity = tmp;
  $this.h6c_1 = newCapacity;
  initializeMetadata($this, newCapacity);
  $this.f6c_1 = new Int32Array(newCapacity);
  var tmp_0 = $this;
  // Inline function 'kotlin.arrayOfNulls' call
  tmp_0.g6c_1 = Array(newCapacity);
}
...
function initializeGrowth($this) {
  $this.o6c_1 = loadedCapacity($this.p6b()) - $this.i6c_1 | 0;
}
function findAbsoluteInsertIndex($this, key) {
  ...
  if ($this.o6c_1 === 0) {
    ...
    tmp_0 = !$this.e6c_1[offset_0 >> 3].q4((offset_0 & 7) << 3).s4(new (Long())(255, 0)).equals(new (Long())(254, 0));
  } else {
    tmp_0 = false;
  }
  if (tmp_0) {
  ...
  $this.i6c_1 = $this.i6c_1 + 1 | 0;
  var tmp_1 = $this;
  var tmp_2 = $this.o6c_1;
  var tmp_3;
  // Inline function 'androidx.collection.isEmpty' call
  // Inline function 'androidx.collection.readRawMetadata' call
  var offset_1 = index_0;
  if ($this.e6c_1[offset_1 >> 3].q4((offset_1 & 7) << 3).s4(new (Long())(255, 0)).equals(new (Long())(128, 0))) {
    tmp_3 = 1;
  } else {
    tmp_3 = 0;
  }
  tmp_1.o6c_1 = tmp_2 - tmp_3 | 0;
  var tmp0_0 = $this.e6c_1;
  var tmp2 = $this.h6c_1;
  var tmp4 = index_0;
...
var MutableIntObjectMapClass;
function MutableIntObjectMap() {
  if (MutableIntObjectMapClass === VOID) {
    class $ extends IntObjectMap() {
      ...
      p6c(key, value) {
        ...
        this.f6c_1[index] = key;
        this.g6c_1[index] = value;
      }
      q6c(key) {
        var tmp$ret$9;
        $l$block: {
      ...
      r6c(index) {
        ...
        var oldValue = this.g6c_1[index];
        this.g6c_1[index] = null;
      ...
      q6b() {
        ...
        if (tmp) {
          ...
          this.r6b(nextCapacity(this.h6c_1));
        }
      }
      s6b() {
        var metadata = this.e6c_1;
        var capacity = this.h6c_1;
        var keys = this.f6c_1;
        var values = this.g6c_1;
      ...
      r6b(newCapacity) {
        var previousMetadata = this.e6c_1;
        var previousKeys = this.f6c_1;
        var previousValues = this.g6c_1;
        var previousCapacity = this.h6c_1;
        initializeStorage(this, newCapacity);
        var newMetadata = this.e6c_1;
        var newKeys = this.f6c_1;
        var newValues = this.g6c_1;
        var capacity = this.h6c_1;
        var inductionVariable = 0;
    ...
    initMetadataForClass($, 'MutableIntObjectMap', MutableIntObjectMap);
    MutableIntObjectMapClass = $;
  }
  return MutableIntObjectMapClass;
}
var IntObjectMapClass;
function IntObjectMap() {
  if (IntObjectMapClass === VOID) {
    class $ {
      constructor() {
        this.e6c_1 = get_EmptyGroup();
        this.f6c_1 = get_EmptyIntArray();
        this.g6c_1 = get_EMPTY_OBJECTS();
        this.h6c_1 = 0;
        this.i6c_1 = 0;
      }
      p6b() {
                ...
                if (inductionVariable_0 < bitCount)
                  do {
                    ...
                    if (slot.s4(new (Long())(255, 0)).d2(new (Long())(128, 0)) < 0) {
                      ...
                      if (value == null) {
                        if (!(other.e1(tmp0) == null) || !other.t6b(tmp0)) {
                          return false;
                        }
                      } else if (!equals(value, other.e1(tmp0))) {
                        return false;
                      }
                    }
                    slot = slot.q4(8);
    ...
    initMetadataForClass($, 'IntObjectMap');
    IntObjectMapClass = $;
  }
  return IntObjectMapClass;
}
//region block: exports
export {
  MutableIntObjectMap as MutableIntObjectMap226x6lnccc731,
};
//endregion

//# sourceMappingURL=IntObjectMap.mjs.map
