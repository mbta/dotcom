...
function initializeStorage($this, initialCapacity) {
  ...
  var newCapacity = tmp;
  $this.f6d_1 = newCapacity;
  initializeMetadata($this, newCapacity);
  var tmp_0 = $this;
  // Inline function 'kotlin.arrayOfNulls' call
  tmp_0.d6d_1 = Array(newCapacity);
  $this.e6d_1 = new Int32Array(newCapacity);
}
...
function initializeGrowth($this) {
  $this.m6d_1 = loadedCapacity($this.p6b()) - $this.g6d_1 | 0;
}
function findIndex($this, key) {
  ...
  $l$loop_0: while (true) {
    ...
    $l$loop: while (true) {
      ...
      if (equals($this.d6d_1[index], key)) {
        return index;
      }
  ...
  if ($this.m6d_1 === 0) {
    ...
    tmp_0 = !$this.c6d_1[offset_0 >> 3].q4((offset_0 & 7) << 3).s4(new (Long())(255, 0)).equals(new (Long())(254, 0));
  } else {
    tmp_0 = false;
  }
  if (tmp_0) {
  ...
  $this.g6d_1 = $this.g6d_1 + 1 | 0;
  var tmp_1 = $this;
  var tmp_2 = $this.m6d_1;
  var tmp_3;
  // Inline function 'androidx.collection.isEmpty' call
  // Inline function 'androidx.collection.readRawMetadata' call
  var offset_1 = index_0;
  if ($this.c6d_1[offset_1 >> 3].q4((offset_1 & 7) << 3).s4(new (Long())(255, 0)).equals(new (Long())(128, 0))) {
    tmp_3 = 1;
  } else {
    tmp_3 = 0;
  }
  tmp_1.m6d_1 = tmp_2 - tmp_3 | 0;
  var tmp0_0 = $this.c6d_1;
  var tmp2 = $this.f6d_1;
  var tmp4 = index_0;
...
var MutableObjectIntMapClass;
function MutableObjectIntMap() {
  if (MutableObjectIntMapClass === VOID) {
    class $ extends ObjectIntMap() {
      ...
      n6d(key, value, default_0) {
        var index = findIndex(this, key);
        var previous = default_0;
        if (index < 0) {
          index = ~index;
        } else {
          previous = this.e6d_1[index];
        }
        this.d6d_1[index] = key;
        this.e6d_1[index] = value;
        return previous;
      }
      o6d(index) {
        this.g6d_1 = this.g6d_1 - 1 | 0;
      ...
      q6b() {
        ...
        if (tmp) {
          ...
          this.r6b(nextCapacity(this.f6d_1));
        }
      }
      s6b() {
        var metadata = this.c6d_1;
        var capacity = this.f6d_1;
        var keys = this.d6d_1;
        var values = this.e6d_1;
      ...
      r6b(newCapacity) {
        var previousMetadata = this.c6d_1;
        var previousKeys = this.d6d_1;
        var previousValues = this.e6d_1;
        var previousCapacity = this.f6d_1;
        initializeStorage(this, newCapacity);
        var newMetadata = this.c6d_1;
        var newKeys = this.d6d_1;
        var newValues = this.e6d_1;
        var capacity = this.f6d_1;
        var inductionVariable = 0;
    ...
    initMetadataForClass($, 'MutableObjectIntMap', MutableObjectIntMap);
    MutableObjectIntMapClass = $;
  }
  return MutableObjectIntMapClass;
}
var ObjectIntMapClass;
function ObjectIntMap() {
  if (ObjectIntMapClass === VOID) {
    class $ {
      constructor() {
        this.c6d_1 = get_EmptyGroup();
        this.d6d_1 = get_EMPTY_OBJECTS();
        this.e6d_1 = get_EmptyIntArray();
        this.f6d_1 = 0;
        this.g6d_1 = 0;
      }
      p6b() {
                ...
                if (inductionVariable_0 < bitCount)
                  do {
                    ...
                    if (slot.s4(new (Long())(255, 0)).d2(new (Long())(128, 0)) < 0) {
                      ...
                      var tmp0 = (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
                      var value = v[index];
                      var index_0 = o.p6d(tmp0);
                      if (index_0 < 0 || !(value === o.e6d_1[index_0])) {
                        return false;
                      }
                    }
                    slot = slot.q4(8);
    ...
    initMetadataForClass($, 'ObjectIntMap');
    ObjectIntMapClass = $;
  }
  return ObjectIntMapClass;
}
//region block: exports
export {
  MutableObjectIntMap as MutableObjectIntMap1ffl70mv56rjv,
};
//endregion

//# sourceMappingURL=ObjectIntMap.mjs.map
