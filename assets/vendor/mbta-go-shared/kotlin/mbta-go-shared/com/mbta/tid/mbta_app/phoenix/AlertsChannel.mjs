...
import { AlertsStreamDataResponse12y031ndw7qai as AlertsStreamDataResponse } from '../model/response/AlertsStreamDataResponse.mjs';
...
//endregion
var com_mbta_tid_mbta_app_phoenix_AlertsChannel$stable;
var CompanionClass;
function Companion() {
  if (CompanionClass === VOID) {
    class $ {
      constructor() {
        this.o9s_1 = 'alerts:v2';
        this.p9s_1 = 'stream_data';
      }
      q9s(payload) {
        ...
        var this_2 = serializer(this_1, createKType(getKClass(AlertsStreamDataResponse()), arrayOf([]), false));
...
//region block: init
com_mbta_tid_mbta_app_phoenix_AlertsChannel$stable = 0;
Companion_instance = new (Companion())();
//endregion
//region block: exports
export {
  Companion_instance as Companion_instance1g2da6xvgv6cx,
};
//endregion

//# sourceMappingURL=AlertsChannel.mjs.map
