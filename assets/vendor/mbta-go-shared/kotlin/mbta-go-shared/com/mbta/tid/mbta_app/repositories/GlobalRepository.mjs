...
//endregion
var com_mbta_tid_mbta_app_repositories_GlobalRepository$stable;
var com_mbta_tid_mbta_app_repositories_MockGlobalRepository$stable;
var com_mbta_tid_mbta_app_repositories_IdleGlobalRepository$stable;
var IGlobalRepositoryClass;
function IGlobalRepository() {
  if (IGlobalRepositoryClass === VOID) {
    class $ {}
    initMetadataForInterface($, 'IGlobalRepository', VOID, VOID, VOID, [0]);
    IGlobalRepositoryClass = $;
  }
  return IGlobalRepositoryClass;
}
function GlobalRepository$getGlobalData$slambda$lambda$lambda($this$timeout) {
  $this$timeout.w5h(new (Long())(10000, 0));
  return Unit_instance;
}
function GlobalRepository$getGlobalData$slambda$lambda$lambda_0($this$url, it) {
  path($this$url, ['api/global']);
  return Unit_instance;
}
function GlobalRepository$getGlobalData$slambda$lambda($etag) {
  return function ($this$get) {
    timeout($this$get, GlobalRepository$getGlobalData$slambda$lambda$lambda);
    $this$get.l5p(GlobalRepository$getGlobalData$slambda$lambda$lambda_0);
...
function _get_mobileBackendClient__q975cc($this) {
  ...
  getPropertyCallableRef('mobileBackendClient', 1, tmp, GlobalRepository$_get_mobileBackendClient_$ref_6mhs5w(), null);
  return tmp0.v1();
}
function GlobalRepository$mobileBackendClient$delegate$lambda($this, $qualifier, $parameters) {
  return function () {
    var tmp0 = $this;
    var tmp2 = $qualifier;
...
function GlobalRepository$_get_mobileBackendClient_$ref_6mhs5w() {
  return function (p0) {
    return _get_mobileBackendClient__q975cc(p0);
  };
}
var GlobalRepository$getGlobalData$slambdaClass;
function GlobalRepository$getGlobalData$slambda() {
  if (GlobalRepository$getGlobalData$slambdaClass === VOID) {
    class $ extends CoroutineImpl() {
          ...
          try {
            ...
            switch (tmp) {
              case 0:
                this.gd_1 = 2;
                this.fd_1 = 1;
                var tmp_0 = _get_mobileBackendClient__q975cc(this.c9x_1);
                suspendResult = tmp_0.h9s(GlobalRepository$getGlobalData$slambda$lambda(this.d9x_1), this);
      ...
      f9x(etag, completion) {
        var i = new (GlobalRepository$getGlobalData$slambda())(this.c9x_1, completion);
        i.d9x_1 = etag;
        return i;
      }
    }
    initMetadataForLambda($, VOID, VOID, [1]);
    GlobalRepository$getGlobalData$slambdaClass = $;
  }
  return GlobalRepository$getGlobalData$slambdaClass;
}
function GlobalRepository$getGlobalData$slambda_0(this$0, resultContinuation) {
  var i = new (GlobalRepository$getGlobalData$slambda())(this$0, resultContinuation);
...
var GlobalRepositoryClass;
function GlobalRepository() {
  if (GlobalRepositoryClass === VOID) {
    class $ {
      constructor(cache) {
        var tmp;
        if (cache === VOID) {
          ...
          var this_1 = serializer(this_0, createKType(getKClass(GlobalResponse()), arrayOf([]), false));
          var tmp$ret$2 = isInterface(this_1, KSerializer()) ? this_1 : THROW_CCE();
          tmp = new (ResponseCache())('global', maxAge, tmp$ret$2, invalidationKey);
        } else {
          tmp = cache;
        }
        cache = tmp;
        ...
        tmp_0.s9w_1 = lazy(mode, GlobalRepository$mobileBackendClient$delegate$lambda(this, null, null));
        this.t9w_1 = this.r9w_1.l8k_1;
      }
      p9w() {
        return this.t9w_1;
      }
      q9w($completion) {
        return this.r9w_1.b8m(GlobalRepository$getGlobalData$slambda_0(this, null), $completion);
      }
    }
    protoOf($).r7v = getKoin;
    initMetadataForClass($, 'GlobalRepository', GlobalRepository, VOID, [IGlobalRepository(), KoinComponent()], [0]);
    GlobalRepositoryClass = $;
  }
  return GlobalRepositoryClass;
}
//region block: init
com_mbta_tid_mbta_app_repositories_GlobalRepository$stable = 8;
com_mbta_tid_mbta_app_repositories_MockGlobalRepository$stable = 8;
com_mbta_tid_mbta_app_repositories_IdleGlobalRepository$stable = 8;
//endregion
//region block: exports
export {
  GlobalRepository as GlobalRepository13d9gx7id4cpg,
  IGlobalRepository as IGlobalRepository2966xpkjzgq2l,
};
//endregion

//# sourceMappingURL=GlobalRepository.mjs.map
