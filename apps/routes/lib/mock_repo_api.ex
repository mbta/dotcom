defmodule Routes.MockRepoApi do
  ...
  @impl Routes.RepoApi
  def get_shapes("9", direction_id: 1) do
    [
      %Routes.Shape{
        direction_id: 1,
        id: "090161",
        name: "City Point - Copley Station",
        polyline: "polyline",
        priority: 3,
        stop_ids: [
          "33",
      ...
      %Routes.Shape{
        direction_id: 1,
        id: "090162",
        name: "City Point - Copley Station via L St",
        polyline: "polyline",
        priority: 0,
        stop_ids: [
          "33",
      ...
      %Routes.Shape{
        direction_id: 1,
        id: "090163",
        name: "City Point - Kenmore Station via Ave Louis Pasteur",
        polyline: "polyline",
        priority: 0,
        stop_ids: [
          "33",
