defmodule SiteWeb.TransitNearMeController.Location do
  @moduledoc """
    ...
    opts =
      Keyword.merge(
        [
          ...
          reverse_geocode_fn: &LocationService.Geocode.reverse_geocode/1
        ],
        opts
      )
  ...
  @spec do_get(map(), keyword()) :: Geocode.t() | :no_address
