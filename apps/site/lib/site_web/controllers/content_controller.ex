defmodule SiteWeb.CMSController do
  ...
  defp handle_page_response(%{__struct__: struct, paragraphs: []} = page, conn)
    ...
    # These content types may or may not have paragraphs. Having them means we can use
    # a generic CMS content template which expects paragraphs. Otherwise, use controllers.
    case struct do
