defmodule Site.MapHelpers do
  ...
  def image(:subway) do
    static_url(
      SiteWeb.Endpoint,
      "/sites/default/files/styles/max_2600x2600/public/media/2023-01/2022-12-12-subway-map-v37f.jpg"
    )
  end
  ...
  def image(:ferry) do
    static_url(
      SiteWeb.Endpoint,
      "/sites/default/files/media/2022-09/2022-09-12-ferry-map.png"
    )
  end
