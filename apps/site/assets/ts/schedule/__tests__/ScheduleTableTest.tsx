...
import { ScheduleTable } from "../components/schedule-finder/ServiceSelector";
...
// @ts-ignore
const serviceSchedules: ServiceSchedule = serviceData;

describe("ScheduleTable", () => {
  it("it renders", () => {
    createReactRoot();
    const tree = renderer.create(<ScheduleTable schedule={serviceSchedules[services[0].id]["0"]}/>);
