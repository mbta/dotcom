defmodule Site.VehicleHelpersTest do
  ...
  @locations %{
    {"CR-483658-501-NewtonRailBus", "place-sstat"} => %Vehicles.Vehicle{
      latitude: 1.1,
      longitude: 2.2,
      status: :stopped,
      stop_id: "place-sstat",
      trip_id: "CR-483658-501-NewtonRailBus",
      shape_id: "9850002"
    }
  }
  ...
  @predictions [
    %Predictions.Prediction{
      ...
      status: "On Time",
      trip: %Schedules.Trip{id: "CR-483658-501-NewtonRailBus", shape_id: "9850002"},
  ...
  describe "build_tooltip_index/3" do
    ...
    test "verify the Vehicle tooltip data" do
      ...
      assert Map.has_key?(@tooltips, {"CR-483658-501-NewtonRailBus", "place-sstat"})
