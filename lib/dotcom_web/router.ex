defmodule DotcomWeb.Router do
  ...
  scope "/", DotcomWeb do
    ...
    get("/schedules/SL1/*path_params", Redirector, to: "/schedules/741", keep_path_params: true)
    get("/schedules/sl1/*path_params", Redirector, to: "/schedules/741", keep_path_params: true)
    get("/schedules/SL2/*path_params", Redirector, to: "/schedules/742", keep_path_params: true)
    get("/schedules/sl2/*path_params", Redirector, to: "/schedules/742", keep_path_params: true)
    get("/schedules/SL3/*path_params", Redirector, to: "/schedules/743", keep_path_params: true)
    get("/schedules/sl3/*path_params", Redirector, to: "/schedules/743", keep_path_params: true)
    get("/schedules/SL4/*path_params", Redirector, to: "/schedules/751", keep_path_params: true)
    get("/schedules/sl4/*path_params", Redirector, to: "/schedules/751", keep_path_params: true)
    get("/schedules/SL5/*path_params", Redirector, to: "/schedules/749", keep_path_params: true)
    get("/schedules/sl5/*path_params", Redirector, to: "/schedules/749", keep_path_params: true)
    get("/schedules/slw/*path_params", Redirector, to: "/schedules/746", keep_path_params: true)

    get("/schedules/CT2/*path_params", Redirector, to: "/schedules/747", keep_path_params: true)
    get("/schedules/ct2/*path_params", Redirector, to: "/schedules/747", keep_path_params: true)
    get("/schedules/CT3/*path_params", Redirector, to: "/schedules/708", keep_path_params: true)
    get("/schedules/ct3/*path_params", Redirector, to: "/schedules/708", keep_path_params: true)
