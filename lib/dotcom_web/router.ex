defmodule DotcomWeb.Router do
  ...
  scope "/", DotcomWeb do
    ...
    get("/schedules/SL1/*path_params", Plugs.PathParamsRedirector, to: "/schedules/741")
    get("/schedules/sl1/*path_params", Plugs.PathParamsRedirector, to: "/schedules/741")
    get("/schedules/SL2/*path_params", Plugs.PathParamsRedirector, to: "/schedules/742")
    get("/schedules/sl2/*path_params", Plugs.PathParamsRedirector, to: "/schedules/742")
    get("/schedules/SL3/*path_params", Plugs.PathParamsRedirector, to: "/schedules/743")
    get("/schedules/sl3/*path_params", Plugs.PathParamsRedirector, to: "/schedules/743")
    get("/schedules/SL4/*path_params", Plugs.PathParamsRedirector, to: "/schedules/751")
    get("/schedules/sl4/*path_params", Plugs.PathParamsRedirector, to: "/schedules/751")
    get("/schedules/SL5/*path_params", Plugs.PathParamsRedirector, to: "/schedules/749")
    get("/schedules/sl5/*path_params", Plugs.PathParamsRedirector, to: "/schedules/749")
    get("/schedules/slw/*path_params", Plugs.PathParamsRedirector, to: "/schedules/746")

    get("/schedules/CT2/*path_params", Plugs.PathParamsRedirector, to: "/schedules/747")
    get("/schedules/ct2/*path_params", Plugs.PathParamsRedirector, to: "/schedules/747")
    get("/schedules/CT3/*path_params", Plugs.PathParamsRedirector, to: "/schedules/708")
    get("/schedules/ct3/*path_params", Plugs.PathParamsRedirector, to: "/schedules/708")
    ...
    get("/schedules/627", Redirector, to: "/service-changes/fall-2025-bus-service-changes#62")
  ...
  scope "/preview", DotcomWeb do
    ...
    live_session :default, layout: {DotcomWeb.LayoutView, :preview} do
      live "/", PreviewLive
      live "/transitstar2000", TransitStar2000
